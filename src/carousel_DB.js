...
import recipes1 from "./imagesWEBP/recipes/1.webp";
import recipes2 from "./imagesWEBP/recipes/2.webp";
import recipes3 from "./imagesWEBP/recipes/3.webp";
import recipes4 from "./imagesWEBP/recipes/4.webp";
import recipes5 from "./imagesWEBP/recipes/5.webp";
import recipes6 from "./imagesWEBP/recipes/6.webp";
import recipes7 from "./imagesWEBP/recipes/7.webp";
import recipes8 from "./imagesWEBP/recipes/8.webp";
import recipes9 from "./imagesWEBP/recipes/9.webp";

import searchEngin1 from "./imagesWEBP/searchEngin/1.webp";
import searchEngin2 from "./imagesWEBP/searchEngin/2.webp";
import searchEngin3 from "./imagesWEBP/searchEngin/3.webp";
import searchEngin4 from "./imagesWEBP/searchEngin/4.webp";
import searchEngin5 from "./imagesWEBP/searchEngin/5.webp";

let projects = [
  {
    name: "Recipes  ",
    type: "full stack",
    addition: " privet source code",
    technology: "react native , elastic search , graphql",
    project_link: "https://github.com/elaad24/recipes_project",
    imagesWEBP: [
      {
        title: "start page",
      ...
      {
        title: "add ingreadents",
        text: "user pick ingreadents",
        image: recipes2,
      },
      {
        title: "suggested recpies",
        text: " ",
        image: recipes3,
      },
      {
        title: "sort option for recpies",
        text: "  ",
        image: recipes4,
      },
      {
        title: "full recipe page ",
        text: "seeing the full recipe and the missing ingreadent ",
        image: recipes5,
      },
      {
        title: "adding to shopping cart missing ingredents ",
        text: " ",
        image: recipes6,
      },
      {
        title: "full recipe page dark mode ",
        text: " ",
        image: recipes7,
      },
      {
        title: "filter optins for recipe sugestion dark mode ",
        text: " ",
        image: recipes8,
      },
      {
...

  {
    ...
    technology: "react, .net core, c#, elasticSearch ,redux-toolkit ",
    project_link: "https://github.com/elaad24/search-engine",
    imagesWEBP: [
      {
        title: "start status  ",
        text: " ",
      ...
      {
        title: "user start searching ",
        text: " ",
        image: searchEngin2,
      },

      {
        title: "user searching just by name ",
        text: "",
        image: searchEngin3,
      },
      {
        title: " user searching just by work title",
        text: "",
        image: searchEngin4,
      },
      {
  ...
  {
    name: "e-store management",
    type: "full stack",
    addition: " intervew project",
